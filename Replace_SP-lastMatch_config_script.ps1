...
$snkSetFile = "F:\users\linhai\文件整理\Hobbies\Game\ShootersPool\snk_lastMatch.json"
$zh8ballSetFile = "F:\users\linhai\文件整理\Hobbies\Game\ShootersPool\zh8ball_lastMatch.json"
...
$shootersPoolExe = "C:\Program Files (x86)\ShootersPool\bin"
# -----------------------------------------------------------------------------------
